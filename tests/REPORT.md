...
Environnement : Apache public du sous-dossier Pathfinder, PHP 8.4.24, SQLite. Aucune configuration Apache globale modifiée.
...
Limites de validation : connexion et exécution MySQL non testées faute de mot de passe ; pas de certification exhaustive de toutes les règles/classes/variantes Pathfinder. Les restrictions de contenu et automatismes partiels sont détaillés dans README.md.
